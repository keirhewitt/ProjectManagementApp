...
def register():
    ...
    if form.validate_on_submit():
        ...
        print("There was an error validating the form.")
...
def update(id):
    ...
    if request.method == 'POST':
        task_to_update.project      = request.form['task-project']
        task_to_update.job          = request.form['task-job']
        task_to_update.assignee     = request.form['task-assignee']
        task_to_update.progress     = request.form['task-progress']
        task_to_update.description  = request.form['task-description']
